...
- Si no puede Agregar un flujo de trabajo de aprobación de SharePoint 2010, consulte [no se puede Agregar el flujo de trabajo de aprobación predeterminado de 2010](https://docs.microsoft.com/alchemyinsights/can-t-add-default-2010-approval-workflow).
- Cómo crear flujos de trabajo:
    - [2013 flujo de trabajo desde SharePoint Designer](https://docs.microsoft.com/sharepoint/dev/general-development/creating-a-workflow-by-using-sharepoint-designer-and-the-sharepoint-wo)
    - [2010 flujo de trabajo desde SharePoint Designer](https://support.office.com/article/introduction-to-designing-and-customizing-workflows-32c9c0bf-5e20-4f74-8b9c-d3ea79f2962b)
