...
ms.locfileid: "29491364"
---
# <a name="troubleshoot-issues-with-apple-mdm-push-certificate-in-microsoft-intune"></a>Solución de problemas con el certificado de inserción de Apple MDM en Intune de Microsoft

Revise los recursos enumerados a continuación para resolver el problema ahora. 
  
1. Revise [este documento](https://docs.microsoft.com/en-us/intune/apple-mdm-push-certificate-get) para configurar o renovar un certificado de inserción de Apple MDM. 
