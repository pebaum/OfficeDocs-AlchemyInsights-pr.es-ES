...
---
# <a name="use-the-onedrive-sync-client-to-sync-onedrive-or-sharepoint-files"></a>Usar el cliente de sincronización de OneDrive para sincronizar archivos de OneDrive o SharePoint
