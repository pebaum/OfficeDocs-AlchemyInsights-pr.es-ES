...
Para deshabilitar el reenvío de correo electrónico para un buzón específico, vea [configurar el reenvío de correo electrónico en Office 365](https://docs.microsoft.com/office365/admin/email/configure-email-forwarding).
