...
3. En la [página Detalles](https://admin.microsoft.com/AdminPortal/Home#/subscriptions/webdirect%252F0dbaa202-d590-4529-98c2-a5e2ebaac702)de la suscripción, seleccione **Actualizar**.  Si la pestaña de **actualización** está vacía, verá una explicación de por qué no puede actualizar en este momento. En su lugar, tendrá que [cambiar los planes manualmente](https://docs.microsoft.com/microsoft-365/commerce/subscriptions/change-plans-manually?view=o365-worldwide).
