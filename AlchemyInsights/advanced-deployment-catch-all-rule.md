...
ms.locfileid: "35357766"
---
# <a name="deploy-office-apps"></a>Implementación de aplicaciones de Office

Para implementar aplicaciones de Office en varios usuarios finales mediante la herramienta de implementación de Office, System Center Configuration Manager, como parte de una imagen de disco del sistema operativo o en un escenario de equipo compartido mediante Windows Server con servicios de escritorio remoto (RDS) o Terminal Server Servicios, considere la posibilidad de usar la guía paso a paso del **Asesor de implementación de Office 365 ProPlus**.
