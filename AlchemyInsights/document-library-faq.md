...
---
# <a name="document-library-faq"></a>Preguntas más frecuentes sobre la biblioteca de documentos

**Solución de problemas con las bibliotecas de documentos**:
...
**Para obtener información sobre las bibliotecas de documentos**:

- [Crear una biblioteca de documentos en SharePoint](https://support.office.com/article/Create-a-document-library-in-SharePoint-306728fe-0325-4b28-b60d-f902e1d75939)
- [Cargar archivos a una biblioteca](https://support.office.com/article/upload-files-to-a-library-da549fb1-1fcb-4167-87d0-4693e93cb7a0)
...
- [Mover o copiar una carpeta, un archivo o un vínculo en una biblioteca de documentos](https://support.office.com/article/move-or-copy-files-in-sharepoint-00e2f483-4df3-46be-a861-1f5f0c1a87bc)
...
- [Configurar una biblioteca para requerir la desprotección de archivos](https://support.microsoft.com/es-ES/office/set-up-a-library-to-require-check-out-of-files-0c73792b-f727-4e19-a1f9-3173899e695b)
...
- [Crear o agregar una columna a una lista o biblioteca](https://support.microsoft.com/es-ES/office/create-a-column-in-a-sharepoint-list-or-library-2b0361ae-1bd3-41a3-8329-269e5f81cfa2)
